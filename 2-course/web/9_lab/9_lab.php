...
<body> 
    ...
    <form action="9_lab.php" method="post"> 
    ...
    <?php 
        ...
        if ($rows != $cols || $rows <= 0 || $cols <= 0 || (int)$cols == 0 || (int)$rows == 0) {
            ...
            echo '<h2>Table 1</h2>';
            echo '<table class="first" border="1">';
            $first_cell_counter++;
        ...
        if ($rows != $cols || $rows <= 0 || $cols <= 0 || (int)$cols == 0 || (int)$rows == 0) {
            ...
            echo "<h2> Table 3 </h2>";
            echo "<table class=\"third\" border=\"1\" style=\"table-layout:fixed; width: 60%;\">";
            for ($tr = 0; $tr < $rows; $tr++) {
                if ($tr % 2 == 0) {
                    echo "<tr>";
        ...
        if ($cols % 3 != 0 || $rows < 5 || $rows <= 0 || $cols <= 0 || (int)$cols == 0 || (int)$rows == 0) {
            ...
            echo "<h2> Table 4 </h2>";
            echo "<table class=\"fourth\" id=\"table-4\" border=\"1\" style=\"table-layout:fixed; width: 60%;\">";
            echo "<tr>";
                for ($td = 0; $td < $cols; $td++) {
                    switch($td % 3) {
                        case 0:
